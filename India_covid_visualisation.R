...
filepath <- "C:\\Users\\AmolShah\\Desktop\\GSoC\\covid_19_india.csv"
...
viz.one <- animint(scatter,plot2,duration=list(month=2000,State=2000))
viz.first <- viz.one
...
#httr::set_config(httr::config(http_version = 0)) #Fix taken from: https://github.com/ropensci/taxize/issues/726
#animint2gist(viz.first)
viz.first
